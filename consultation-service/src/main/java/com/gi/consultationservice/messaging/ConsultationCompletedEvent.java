...
public class ConsultationCompletedEvent {
    ...
    public ConsultationCompletedEvent(Long consultationId, Long rendezVousId, Long patientId, Long medecinId, Long cabinetId, String diagnostic, String traitement, Instant timestamp) {
